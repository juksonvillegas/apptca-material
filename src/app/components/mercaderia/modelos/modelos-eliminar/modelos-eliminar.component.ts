...
@Component({
  selector: 'app-modelos-eliminar',
  templateUrl: './modelos-eliminar.component.html',
  styleUrls: ['./modelos-eliminar.component.css']
})
export class ModelosEliminarComponent implements OnInit {
  modelo = 'modelos/';
  id = '';
